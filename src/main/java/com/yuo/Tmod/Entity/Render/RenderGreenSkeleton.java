...
public class RenderGreenSkeleton extends RenderLiving<EntityGreenSkeleton> {
    private static final ResourceLocation GREEN_SKELETON_TEXTURE = new ResourceLocation(Tmod.MOD_ID + ":" + "textures/entity/green_skeleton.png");
    ...
    public RenderGreenSkeleton(RenderManager rendermanagerIn) {
        ...
        this.addLayer(new LayerGreenSkeletonEyes(this));
    }
