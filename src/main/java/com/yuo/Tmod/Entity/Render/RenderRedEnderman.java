...
public class RenderRedEnderman extends RenderLiving<EntityRedEnderman> {
    private static final ResourceLocation RED_ENDERMAN_TEXTURE = new ResourceLocation(Tmod.MOD_ID + ":" + "textures/entity/red_enderman.png");

    public RenderRedEnderman(RenderManager rendermanagerIn) {
        super(rendermanagerIn, new ModelEnderman(0.0f), 0.5f);
        this.addLayer(new LayerRedEndermanEyes(this));
    }
