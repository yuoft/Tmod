...
import com.yuo.Tmod.Entity.AI.AISkeletonAttackBow;
import com.yuo.Tmod.Entity.AI.AISkeletonAttackSword;
...
public class EntityGreenSkeleton extends EntitySkeleton {
    public EntityGreenSkeleton(World worldIn) {
        super(worldIn);
