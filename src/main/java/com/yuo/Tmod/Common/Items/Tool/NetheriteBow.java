...
public class NetheriteBow extends ItemBow {
    public NetheriteBow(String name) {
        this.setUnlocalizedName(name);
        this.setMaxDamage(448);
    ...
    public EntityArrow customizeArrow(EntityArrow arrow) {
        return new EntityNetheriteArrow(arrow.world, (EntityLivingBase) arrow.shootingEntity);
    }

    @Override
    protected boolean isArrow(ItemStack stack) {
        return stack.getItem() == ItemLoader.netheriteArrow;
    }
}
