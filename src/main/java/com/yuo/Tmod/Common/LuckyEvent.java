...
import com.yuo.Tmod.Entity.EntityGreenSkeleton;
import com.yuo.Tmod.Entity.EntityGreenSpider;
import com.yuo.Tmod.Entity.EntityGreenZombies;
import com.yuo.Tmod.Entity.EntityKiana;
import com.yuo.Tmod.Entity.EntityRedCreeper;
import com.yuo.Tmod.Entity.EntityRedEnderman;
...
public class LuckyEvent {
    ...
    public void luckEvent(BlockEvent.BreakEvent event) {
        ...
        if (block.equals(BlockLoader.unluckyBlock))//霉运方块事件
        {
            ...
            switch (num) {
                case 0:
                    spawnLightingBolt(worldIn, pos, 3);
                    break;
                case 1:
                    spawnRangeBlock(worldIn, pos, Blocks.LAVA, 1, 2);
                    break;
                case 2:
                    trappedPlayer(worldIn, player);
                    break;
                case 3:
                    spawnMob(worldIn, pos, new EntityRedZombies(worldIn), 1);
                    break;
                case 4:
                    spawnMob(worldIn, pos, new EntityGreenCreeper(worldIn), 1);
                    break;
                case 5:
                    spawnMob(worldIn, pos, new EntityRedEnderman(worldIn), 1);
                    break;
                case 6:
                    spawnMob(worldIn, pos, new EntityRedSkeleton(worldIn), 1);
                    break;
                case 7:
                    spawnMob(worldIn, pos, new EntityRedSpider(worldIn), 1);
                    break;
                case 8:
                    spawnMob(worldIn, pos, new EntityGreenZombies(worldIn), RANDOM.nextInt(3) + 1);
                    break;
                case 9:
                    spawnMob(worldIn, pos, new EntityGreenSpider(worldIn), RANDOM.nextInt(3) + 1);
                    break;
                case 10:
                    spawnMob(worldIn, pos, new EntityGreenSkeleton(worldIn), RANDOM.nextInt(3) + 1);
                    break;
                case 11:
                    spawnTnt(worldIn, pos, RANDOM.nextInt(5) + 1);
                    break;
                case 12:
                    spawnAnvil(worldIn, player, Blocks.ANVIL, 1);
                    break;
                case 13:
                    debuff(worldIn, player);
                    break;
                case 14:
                    spawnAnvil(worldIn, player, Blocks.SAND, RANDOM.nextInt(3) + 1);
                    break;
                case 15:
                    playerFly(worldIn, player);
                default:
                    unLuckyNullEvent(worldIn, pos, player);
                    break;
            }
        }
        if (block.equals(BlockLoader.luckyBlock))//幸运方块事件
        {
            ...
            switch (num) {
                case 0:
                    spawnEntityItem(worldIn, pos, Items.DIAMOND, RANDOM.nextInt(8) + 4);
                    break;
                case 1:
                    spawnEntityItem(worldIn, pos, Items.EMERALD, RANDOM.nextInt(8) + 2);
                    break;
                case 2:
                    spawnEntityItem(worldIn, pos, Items.GOLD_INGOT, RANDOM.nextInt(8) + 8);
                    break;
                case 3:
                    spawnEntityItem(worldIn, pos, Items.IRON_INGOT, RANDOM.nextInt(8) + 12);
                    break;
                case 4:
                    spawnEntityItem(worldIn, pos, Items.REDSTONE, RANDOM.nextInt(8) + 8);
                    break;
                case 5:
                    spawnEntityBlock(worldIn, pos, Blocks.LAPIS_ORE, RANDOM.nextInt(8) + 4);
                    break;
                case 6:
                    spawnEntityBlock(worldIn, pos, Blocks.DIAMOND_BLOCK, RANDOM.nextInt(2) + 2);
                    break;
                case 7:
                    spawnEntityBlock(worldIn, pos, Blocks.EMERALD_BLOCK, RANDOM.nextInt(2) + 1);
                    break;
                case 8:
                    spawnEntityBlock(worldIn, pos, Blocks.GOLD_BLOCK, RANDOM.nextInt(2) + 2);
                    break;
                case 9:
                    spawnEntityBlock(worldIn, pos, Blocks.IRON_BLOCK, RANDOM.nextInt(2) + 3);
                    break;
                case 10:
                    spawnEntityBlock(worldIn, pos, Blocks.REDSTONE_BLOCK, RANDOM.nextInt(2) + 2);
                    break;
                case 11:
                    spawnEntityBlock(worldIn, pos, Blocks.LAPIS_BLOCK, RANDOM.nextInt(2) + 2);
                    break;
                case 12:
                    oreGiftBag(worldIn, pos);
                    break;
                case 13:
                    spawnCake(worldIn, pos);
                    break;
                case 14:
                    luckyVillager(worldIn, pos);
                    break;
                default:
                    luckyNullEvent(worldIn, pos);
                    break;
            }
        }
    }
