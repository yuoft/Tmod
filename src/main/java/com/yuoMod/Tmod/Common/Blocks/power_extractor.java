...
public class power_extractor extends BlockContainer
{
	//方向
    ...
    public IBlockState getStateFromMeta(int meta)//从值得到状态
    {
		...
		switch(meta)
		{
		case 0: facing=EnumFacing.NORTH;burning=false;break;
		case 1: facing=EnumFacing.SOUTH;burning=false;break;
		case 2: facing=EnumFacing.EAST;burning=false;break;
		case 3: facing=EnumFacing.WEST;burning=false;break;
		case 4: facing=EnumFacing.NORTH;burning=true;break;
		case 5: facing=EnumFacing.SOUTH;burning=true;break;
		case 6: facing=EnumFacing.EAST;burning=true;break;
		case 7: facing=EnumFacing.WEST;burning=true;break;
		}
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tile instanceof MyTileEntity) {
            final ItemStackHandler inv = ((MyTileEntity)tile).getInventory();
